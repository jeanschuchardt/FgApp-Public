...
namespace FGApp.API
{
    ...
    public class CargosController : Controller
    {
        ...
        //{
        //    List<NumerosAnalisesDTO> listaPartidoServidores = new RegioesCargosBO(_connectionStrings.DefaultConnection).GetServidoresPorPartido(new NumerosAnalisesDTO() { DataCargos = new DateTime(ano, 1, 1) });
        ...
        //{
        //    List<NumerosAnalisesDTO> listaPartidoServidores = new RegioesCargosBO(_connectionStrings.DefaultConnection).GetDistribuicaoFuncoes(new NumerosAnalisesDTO() { DataCargos = new DateTime(ano, 1, 1) });
        ...
        //{
        //    List<NumerosAnalisesDTO> listaServidoresPorAno = new RegioesCargosBO(_connectionStrings.DefaultConnection).GetServidoresPorAno(new NumerosAnalisesDTO() { Estado = estado, TipoCargos = tipoCargo});
        ...
        //{
        //    List<NumerosAnalisesDTO> listaRegioesCargos = new RegioesCargosBO(_connectionStrings.DefaultConnection).GetAllRegioesCargos();
