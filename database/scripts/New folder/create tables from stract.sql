...
-- union
-- SHOW CREATE TABLE tbm_cargo_servidores
-- union
...
--    KEY `uf` (`UF`(5))
--  ) ENGINE=InnoDB AUTO_INCREMENT=1834985 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--    KEY `id_servidor` (`Id_SERVIDOR_PORTAL`) /*!80000 INVISIBLE */,
--    KEY `nome_servidor` (`NOME`(100)),
--    KEY `cpf` (`CPF`(15))
--  ) ENGINE=InnoDB AUTO_INCREMENT=367552 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci
...
--    PRIMARY KEY (`id`),
--    UNIQUE KEY `id` (`id`) /*!80000 INVISIBLE */,
--    UNIQUE KEY `cargo_unik` (`SIGLA_FUNCAO`(10),`NIVEL_FUNCAO`(10),`FUNCAO`(10),`UORG_EXERCICIO`(100),`DATA_INICIO_AFASTAMENTO`,`DATA_TERMINO_AFASTAMENTO`,`DATA_INGRESSO_CARGOFUNCAO`,`ANO`(3),`MES`,`FK_SERVIDOR`,`UF_EXERCICIO`(5)) /*!80000 INVISIBLE */,
--    KEY `sigla` (`SIGLA_FUNCAO`(10)),
--    KEY `funcao` (`NIVEL_FUNCAO`(5)),
--    KEY `fk_cas_ser` (`FK_SERVIDOR`) /*!80000 INVISIBLE */,
--    KEY `ano_mes` (`ANO`,`MES`),
--    CONSTRAINT `fk_cas_ser` FOREIGN KEY (`FK_SERVIDOR`) REFERENCES `cadastro_servidores` (`id`)
...
--  ) ENGINE=InnoDB AUTO_INCREMENT=1900516 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci